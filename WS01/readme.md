...
* Version (1.0)
 ...
 In process of doing your first workshop you are not doing any coding but rather organizing an application into modules. Then you will compile each module separately and construct an executable from the results of each compilation.
